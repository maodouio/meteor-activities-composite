...
httpCall = function(method, url, options, callback) {
  ...
  try {
    ...
    } else if (!options.responseType && typeof Uint8Array !== "undefined" && content instanceof Uint8Array){
      //Must set this to text or '' as if we dont an error is thrown when setting reading xhr.response or xhr.responseText
      xhr.responseType = "text";
      //The fix for Android <= 4.4
